...
public class InjectTimeUnitTest {
    ...
    public void addition_isCorrect() throws Exception {
        ...
        File file = new File("/Users/xinxin.wang/Downloads/ASMInject/app/src/test/java2/com/enjoy/asminject");
        file.mkdirs();

        FileOutputStream fos = new FileOutputStream
                ("/Users/xinxin.wang/Downloads/ASMInject/app/src/test/java2/com/enjoy/asminject/InjectTest" +
                        ".class");
